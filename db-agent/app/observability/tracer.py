"""Langfuse tracing for db-agent via public ingestion API."""
...
class DbAgentTracer:
    ...
    async def start_trace(
        ...
        *,
        ...
        if not self.enabled:
            return
        meta = {"source": "db-agent", **(metadata or {})}
    ...
    async def span(
        ...
        *,
        ...
        body: dict[str, Any] = {
            ...
            "metadata": {"source": "db-agent", **(metadata or {})},
            "level": level,
        }
        if status_message:
    ...
    async def generation(
        ...
        *,
        ...
        """Register an LLM call as a Langfuse generation with token + cost details."""
        if not self.enabled:
            return None
