...
def _route_on_error(state: DbAgentState) -> str:
    if state.get("error"):
        return "end"
    return "continue"
...
workflow.add_conditional_edges(
    "parse_intent",
    _route_on_error,
    {"continue": "resolve_params", "end": END},
)
workflow.add_conditional_edges(
    "resolve_params",
    _route_on_error,
    {"continue": "validate_safety", "end": END},
)
workflow.add_conditional_edges(
    "validate_safety",
    _route_on_error,
    {"continue": "check_intent_policy", "end": END},
)
workflow.add_conditional_edges(
    "check_intent_policy",
    _route_on_error,
...
workflow.add_conditional_edges(
    "execute_tool",
    _route_on_error,
    {"continue": "format_response", "end": END},
)
